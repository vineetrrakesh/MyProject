...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD calculateTotalPrice.
    MODIFY ENTITIES OF zi_rap_travel_vinee IN LOCAL MODE
        ENTITY travel
  ...
  METHOD calculateTravelID.
    ...
    READ ENTITIES OF zi_rap_travel_vinee IN LOCAL MODE
      ENTITY Travel
...
*    ENDIF.
    ...
    DATA business_data TYPE TABLE OF zrap_vineez_travel_agency_es5.
    ...
    IF  agencies IS NOT INITIAL.
      ...
      TRY.
          ...
          NEW zcl_ce_rap_agency_vinee( )->get_agencies(
            EXPORTING
...
*          IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[ agency_id = travel-AgencyID ] ).
            IF travel-AgencyID IS INITIAL OR NOT line_exists( business_data[ agencyid = travel-AgencyID ] ).
              ...
              APPEND VALUE #( %tky        = travel-%tky
                              %state_area = 'VALIDATE_AGENCY'
                              %msg        = NEW zcm_rap_vinee(
                                                severity = if_abap_behv_message=>severity-error
                                                textid   = zcm_rap_vinee=>agency_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         ...
                         %msg        = NEW zcm_rap_vinee(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zcm_rap_vinee=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_vinee(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_vinee=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zcm_rap_vinee(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zcm_rap_vinee=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zcm_rap_vinee( severity = if_abap_behv_message=>severity-error
                                                            textid   = zcm_rap_vinee=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
  ...
  METHOD is_create_granted.
    AUTHORITY-CHECK OBJECT 'ZOSTATVINE'
        ID 'ZOSTATVINE' DUMMY
        ID 'ACTVT' FIELD '01'.
  ...
  METHOD is_delete_granted.
    IF has_before_image = abap_true.
      AUTHORITY-CHECK OBJECT 'ZOSTATVINE'
        ID 'ZOSTATVINE' FIELD overall_status
        ID 'ACTVT' FIELD '06'.
    ELSE.
      AUTHORITY-CHECK OBJECT 'ZOSTATVINE'
        ID 'ZOSTATVINE' DUMMY
