...
define view entity ZC_RAP_Booking_U_vinee
  as projection on ZI_RAP_Booking_U_vinee
{
      //ZI_RAP_BOOKING_U_vinee
  ...
  key BookingID,
      ...
      _Carrier,
      _Customer,
      _Travel : redirected to parent ZC_RAP_Travel_U_vinee
}
